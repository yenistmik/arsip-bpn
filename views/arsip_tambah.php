                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="ruang_arsip" class="col-sm-3 control-label">Ruang Arsip</label>
                               <div class="col-sm-2 col-xs-9">
                                <select name="ruang_arsip" class="form-control">
                                     <option value="Arsip Pendaftaran">Arsip Pendaftaran</option>
                                    <option value="Arsip Penerimaan">Arsip Penerimaan</option>
                                </select>
                            </div>
                        </div>
						 <div class="form-group">
						 ...
						 <div class="form-group">
                            <label for="para_pihak" class="col-sm-3 control-label">Nama Pemohon</label>
                            <div class="col-sm-9">
                                <input type="text" name="para_pihak" class="form-control" id="inputEmail3" placeholder="Inputkan Para Pihak yang Terlibat" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="no_perkara" class="col-sm-3 control-label">Nomor Berkas</label>
                            <div class="col-sm-9">
