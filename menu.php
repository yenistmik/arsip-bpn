...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="?page=utama">Sistem Informasi Pengarsipan Berkas Hak Tanggungan dan Roya Pada Kantor BPN Kisaran</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="?page=surat&actions=report">Laporan Surat Masuk</a></li>
						            <li><a href="?page=peminjaman&actions=report">Laporan Surat Keluar</a></li>
                    </ul>
                </li>
				 <li><a href="?page=surat&actions=masuk">Surat Masuk</a></li>
